...
<div class="max-w-3xl mx-auto space-y-8">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden animate-fade-in-up delay-1">
        <div class="bg-gradient-to-r from-indigo-600 to-indigo-700 px-6 py-5">
            ...
            <p class="text-indigo-100 text-sm mt-1">Mettez à jour vos coordonnées</p>
        </div>
        <div class="p-6">
            <form method="POST" action="{{ route('candidat.profil.update') }}" enctype="multipart/form-data">
                ...
                <div class="mt-8 flex justify-end">
                    <button type="submit"
                            class="px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-lg hover:from-indigo-700 hover:to-indigo-800 transition-all shadow-md hover:shadow-lg flex items-center gap-2">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden animate-fade-in-up delay-2">
        ...
        <div class="p-6">
            <form method="POST" action="{{ route('candidat.profil.password') }}">
                @csrf
                @method('PUT')
