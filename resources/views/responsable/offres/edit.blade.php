...
<div class="max-w-4xl mx-auto animate-fade-in-up delay-1">
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-[#970d0d] to-[#7a0a0a] px-6 py-5 rounded-t-xl">
            ...
            <p class="text-red-100 text-sm mt-1">Modifiez les informations ci‑dessous</p>
        </div>

        <!-- Formulaire -->
        <div class="p-6">
            <form method="POST" action="{{ route('responsable.offres.update', $offre) }}">
                @csrf
                @method('PUT')
                ...
                <!-- Ligne Type contrat / Niveau exp / Niveau études / (4 colonnes) -->
