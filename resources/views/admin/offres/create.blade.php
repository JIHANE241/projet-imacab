...
@section('header', 'Créer une offre')
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="p-6">
            <form method="POST" action="{{ route('admin.offres.store') }}">
                @csrf
                <input type="hidden" name="direction_id" value="{{ request('direction_id') ?? old('direction_id') }}">
                ...
                <div class="mt-8 flex items-center justify-end gap-4">
                    <a href="{{ route('admin.offres.index', ['direction_id' => request('direction_id')]) }}" 
