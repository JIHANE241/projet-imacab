                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            ...
                            <tr class="table-row">
                                <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">{{ $cat->nom }}</td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right">
                                    <div class="flex items-center justify-end space-x-2">
                                        <!-- Formulaire de modification inline -->
                                        <form action="{{ route('admin.categories.update', $cat) }}" method="POST" class="inline">
                                            @csrf @method('PUT')
                    ...
                    @if($categories->isEmpty())
                        <p class="text-center text-gray-500 py-4">Aucune catégorie enregistrée.</p>
                    @endif
                </div>
            </div>
        </div>
