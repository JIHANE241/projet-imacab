...
<div class="max-w-3xl mx-auto animate-fade-in-up delay-1">
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-[#970d0d] to-[#7a0a0a] px-6 py-5 rounded-t-xl">
            <h2 class="text-xl font-bold text-white">Modifier un utilisateur</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative input-icon border border-gray-200 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $utilisateur->name) }}" required
                    ...
                    <div>
                        ...
                        <div class="relative input-icon border border-gray-200 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500">
                            ...
                            <input type="text" name="prenom" id="prenom" value="{{ old('prenom', $utilisateur->prenom) }}"
                                class="pl-10 pr-4 py-2 w-full border-0 focus:ring-0 focus:outline-none"
                                placeholder="Jean">
                        </div>
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="relative input-icon border border-gray-200 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500">
                        ...
                        <select name="role" id="role" required
                            ...
                            <option value="admin" {{ old('role', $utilisateur->role) == 'admin' ? 'selected' : '' }}>Admin RH</option>
                            <option value="responsable" {{ old('role', $utilisateur->role) == 'responsable' ? 'selected' : '' }}>Responsable département</option>
                            <option value="candidat" {{ old('role', $utilisateur->role) == 'candidat' ? 'selected' : '' }}>Candidat</option>
                        </select>
                    ...
                    <div class="relative input-icon border border-gray-200 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500">
                        ...
                        <select name="direction_id" id="direction_id"
                            ...
                            @foreach($directions as $direction)
                                <option value="{{ $direction->id }}" {{ old('direction_id', $utilisateur->direction_id) == $direction->id ? 'selected' : '' }}>{{ $direction->nom }}</option>
                            @endforeach
                        </select>
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                            <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
